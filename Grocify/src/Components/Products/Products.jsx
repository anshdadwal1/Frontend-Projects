      ...
      <div className="max-w-[1400px] mx-auto px-10 py-20">
        ...
        <div className="grid grid-col-1 md:grid-cols-4 gap-9 mt-20">
         ...
         <div className="mt-15 flex justify-center">
          <Link to="/All Products" className='bg-gradient-to-b from-orange-400 to-orange-500 text-white px-8 py-3 rounded-lg md:text-lg text-md hover:scale-105 hover:to-orange-600 transition-all duration-300 cursor-pointer'>View All
                    </Link>
         </div>
      </div>
    </section>
